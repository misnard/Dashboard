...
def init_db():
    ...
    user = User("maher.isnard@gmail.com", "madinina", "Maher", "Isnard")

    enterprise = Enterprise("Maher Isnard", "41 Grande rue saint michel", "Toulouse", "31400",
                            "06 02 72 19 82",
                            "maher.isnard@gmail.com",
                            "<span class='font-weight-bold'>Coordonnées bancaires</span><br>" +
                            "Titulaire du compte : Maher Isnard <br>" +
                            "Banque : Revolut <br>" +
                            "IBAN : GB06 REVO 0099 6933 3510 74 <br>" +
                            "CODE BIC : REVOGB21", "123123123123")
